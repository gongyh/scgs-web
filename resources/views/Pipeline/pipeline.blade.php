        ...
        <form action="/execute/start?sampleID={{$sample_id}}" method="POST">
          ...
          <div>
            ...
            <div class="mt-2">
              ...
              <input type="text" name="genus_name" class="w-50 form-control genus_name {{$genus_name == null?'no-display':''}}" value={{$genus_name == null?'':$genus_name}}>
            </div>
            <!-- error message -->
            @if (count($errors) > 0)
            ...
            <div class="mt-2">
              ...
              <div class="w-50 border db_path rounded shadow-sm p-2 resfinder_db_path {{$resfinder_db?'no-display':''}}">{{$pipelineParams->resfinder_db_path}}</div>
            </div>
            <div class="mt-2">
              <div class="custom-control custom-checkbox mr-4">
              ...
              <div class="w-50 border db_path rounded shadow-sm p-2 nt_db_path {{$nt_db? 'no-display':''}}">{{$pipelineParams->nt_db_path}}</div>
            </div>
            <div class="mt-2">
              <div class="custom-control custom-checkbox mr-4">
              ...
              <div class="w-50 border db_path rounded shadow-sm p-2 kraken_db_path {{$kraken_db ?'no-display':''}}">{{$pipelineParams->kraken_db_path}}</div>
            </div>
            <div class="mt-2">
              <div class="custom-control custom-checkbox mr-4">
              ...
              <div class="w-50 border db_path rounded shadow-sm p-2 eggnog_db_path {{$eggnog ?'no-display':''}}">{{$pipelineParams->eggnog_db_path}}</div>
            </div>
            <div class="mt-2">
              <div class="custom-control custom-checkbox mr-4">
              ...
              <div class="w-50 border db_path rounded shadow-sm p-2 kofam_profile_path {{$kofam_profile?'no-display':''}}">{{$pipelineParams->kofam_profile_path}}</div>
            </div>
            <div class="mt-2">
              <div class="custom-control custom-checkbox mr-4">
              ...
              <div class="w-50 border db_path rounded shadow-sm p-2 kofam_kolist_path {{$kofam_kolist?'no-display':''}}">{{$pipelineParams->kofam_kolist_path}}</div>
            </div>
          </div>
