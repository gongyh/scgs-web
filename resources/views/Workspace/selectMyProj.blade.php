              ...
              <table class="table table-condense">
                <thead>
                  <tr>
                    ...
                    <th></th>
                    <th scope="col" class="table-header"><a href="/projects/create?labID={{$labID}}&from=myProject">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-item">
                      <a href="/projects/delete?labID={{$labID}}&projectID={{$selectMyProj->id}}&from=myProject" onclick="if(confirm('Are you sure to delete?')==false) return false;">
