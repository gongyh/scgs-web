              ...
              <table class="table table-condense">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><a href="/samples/create?projectID={{$projectID}}&from=workspace"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
