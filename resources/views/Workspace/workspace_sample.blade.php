    ...
    <div class="col-md-6">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="/workspace/myProject">Myprojects</a></li>
          <li class="breadcrumb-item active" aria-current="page">Mysamples</li>
          </li>
        </ol>
      </nav>
      <div class="result">
          ...
          <div class="project_sample">
            ...
            <div class="d-flex justify-content-between">
              <div>
                ...
                <button type="button" class="btn btn-primary mr-4" data-toggle="modal" data-target="#myModal">
              ...
              <a class="btn btn-default pt-2 font-weight-bold font-italic ml-3" href="/samples/create?projectID={{$projectID}}&from=workspace">Add Samples</a>
            ...
            <div class="d-flex mt-3 p-2 rounded-lg border shadow-sm overflow-auto">
              ...
              <div class="font-normal">
                ...
                <div class="">
                  Species : {{$sample->getSpeciesName($selectSample->species_id)}}
                </div>
                <div class="">
                  Pairends : {{$selectSample->pairends == 1 ? 'Yes':'No'}}
                </div>
                <div class="">
                  Status :
