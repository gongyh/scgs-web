    ...
    <div class="col-md-6">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">My Samples</li>
          </li>
        </ol>
      </nav>
      <div class="result">
        <div class="result-detail">
          ...
          <div class="project_desc pb-3">
            ...
            <a href="/executeProj?projectID={{$projectID}}&from=workspace" class="ml-3 btn btn-primary">Execute the project <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="project_sample mt-3">
            ...
            <div class="d-flex justify-content-between">
              <div>
                ...
                <button type="button" class="btn btn-primary mr-4" data-toggle="modal" data-target="#myModal_sample_file">
              ...
              <a class="btn btn-default pt-2 font-weight-bold ml-3" href="/samples/create?projectID={{$projectID}}&from=workspace">Add Sample</a>
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <input type="file" name="sample_file" id="workspace_sample_file" multiple class="file-loading sample_file">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="d-flex mt-3 p-2 rounded-lg border shadow-sm overflow-auto">
              ...
              <div class="font-normal">
                ...
                <div class="edit-delete-execute">
                  ...
                  <a href="/samples/delete?projectID={{$projectID}}&sampleID={{$selectSample->id}}&from=workspace" onclick="if(confirm('Are you sure to delete?')==false) return false;"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="/execute?sampleID={{$selectSample->id}}&from=workspace" title="execute the pipeline">
