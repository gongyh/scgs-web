              ...
              <table class="table table-condense">
                <thead>
                  <tr>
                    ...
                    <th></th>
                    <th scope="col" class="table-header"><a href="/labs/create?from=myLab">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-item">
                      ...
                      <a href="/labs/delete?labID={{$myLab->id}}&from=myLab" onclick="if(confirm('Are you sure to delete?')==false) return false;">
                    ...
                    <td class="table-item">
                      <a href="/labs/update?labID={{$myLab->id}}&from=myLab">
