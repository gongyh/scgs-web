              ...
              <table class="table table-condense">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-item">
                      @if($isAdmin)
                      <a href="{{url('institutions/labs/delete',['id'=>$selectLab->id])}}" class="btn btn-primary btn-sm" onclick="if(confirm('Are you sure to delete?')==false) return false;">delete</a>
                      @endif

                      @if($isAdmin || $isPI->contains($selectLab->id))
                      <a href="{{ url('institutions/labs/update',['id'=>$selectLab->id])}} " class="btn btn-primary btn-sm">edit</a>
                      @endif
