              ...
              <table class="table table-condense">
                <thead>
                  <tr>
                    ...
                    <th></th>
                    <th scope="col" class="table-header"><a href="/species/create">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-item">
                      <a href="/species/delete?speciesID={{$species->id}}&page={{$current_page}}" onclick="if(confirm('Are you sure to delete?')==false) return false;">
                    ...
                    <td class="table-item">
                      <a href="/species/update?speciesID={{$species->id}}&page={{$current_page}}">
