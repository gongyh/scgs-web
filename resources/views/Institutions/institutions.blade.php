              ...
              <table class="table table-condense">
                <thead>
                  <tr>
                    ...
                    <th></th>
                    <th scope="col" class="table-header"><a href="/institutions/create">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-item">
                      <a href="/institutions/delete?instiID={{$institution->id}}&page={{$current_page}}" onclick="if(confirm('Are you sure to delete?')==false) return false;">
                    ...
                    <td class="table-item">
                      <a href="/institutions/update?instiID={{$institution->id}}&page={{$current_page}}">
