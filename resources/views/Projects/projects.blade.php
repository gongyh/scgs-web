              ...
              <table class="table table-condense">
                <thead>
                  <tr>
                    ...
                    @if($isAdmin || $isPI)
                    <th scope="col" class="add"><a href="projects/create"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-item">{{$Project->getLabName($Project->labs_id)}}</td>
                    <td class="delete">
